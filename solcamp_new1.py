                    ...
                    if sel_month == month:
                        try:
                                    ...
                                    if result_txt.get('ERROR') == '이미 예약되었거나, 예약할 수 없는 구역이 선택되었습니다.' \
                                        ...
                                        if result_txt.get('ERROR') == '이미 예약되었거나, 예약할 수 없는 구역이 선택되었습니다.':
                                            ...
                                            if not test:
                                                ...
                                                print(machine_id_txt + ' 이미 선점된 사이트 입니다. 재시도 합니다.')
                                        else:
                                            continue_work = False
                            ...
                            retry_moudule(userAgent, site, target_date, room, fix_room_num, thread_name, continue_work,
                                          trying, user_phone1, user_phone2, user_phone3, cookie, dict_data)
                    ...
                    if result_txt.get('ERROR') == '이미 예약되었거나, 예약할 수 없는 구역이 선택되었습니다.' \
                        ...
                        if result_txt.get('ERROR') == '이미 예약되었거나, 예약할 수 없는 구역이 선택되었습니다.':
                            ...
                            if not test:
                                ...
                                print(machine_id_txt + ' 이미 선점된 사이트입니다. 재시도 합니다.')
                        else:
                            continue_work = False
                            print(machine_id_txt + result_txt.get('ERROR'))
                    else:

...
DATASET['RESET'] = False  # 자리를 잡을 때 해당 기능을 사용하여 예약 유무 확인

# 사용자 설정 USER_NO : 최종예약자
DATASET['CUSTOMER'] = '13'
DATASET['HOLDER'] = '13'
DATASET['FINAL_RESERVATION'] = True

# 숙박 설정
DATASET['SELECT_DATE'] = ['2025-09-20']  # 지정일 기준 * 연박 ex) 2025-08-14 + 2박 => 2025-08-14 ~ 2025-08-16

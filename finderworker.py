...
import msmtfindprocessor as processor
import tempfile
...
DATASET['CANCEL'] = False

# 숙박 설정
DATASET['SELECT_DATE'] = ['2025-10-03', '2025-10-04', '2025-10-05', '2025-10-06']    # 지정일 기준 * 연박 ex) 2025-08-14 + 2박 => 2025-08-14 ~ 2025-08-16
